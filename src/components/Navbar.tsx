...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  const navLinkStyle = ({ isActive }: { isActive: boolean }) =>
    `transition-colors py-1 ${
      isActive ? 'text-[#C67C4E] border-b-2 border-[#C67C4E]' : 'text-gray-800 hover:text-[#C67C4E]'
    }`;
    ...
    <>
      ...
      <div className="bg-[#111111] text-white text-[10px] sm:text-[11px] font-button font-medium py-2 border-b border-gray-800">
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-wrap items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-4 text-gray-300">
            <a
              href="https://wa.me/919876543210?text=Hi%20Rexine%20Centre%2C%20I%20need%20wholesale%20catalogue%20and%20pricing."
              target="_blank"
      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="bg-[#C67C4E] hover:bg-[#b06a3d] text-white px-5 py-2.5 rounded-lg font-button text-xs font-bold uppercase tracking-wider flex items-center gap-2 transition-all shadow-md group"
          >
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-white border-b border-gray-200 px-6 py-6 space-y-4 font-button text-xs font-bold uppercase tracking-wider text-gray-900 animate-fade-in">
          ...
          <NavLink to="/collections" onClick={() => setMobileMenuOpen(false)} className="block py-2">
            Collections
          </NavLink>
